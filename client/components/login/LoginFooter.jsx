...
export function LoginFooter() {  
  ...
  if (profileName) {
    profileStatus = <footer>Logged in as: <Link className="footerLink" to={"/profile"}>{profileName}</Link><p>
        <button className="footerButton" onClick={handleSubmitLogout}>Log out</button>
        </p></footer>;
  } else {
